...
{
    private readonly Func<BotMember, float> _getRequiredExperience;
    private readonly BotMember _member;
    ...
    public RewardingBuilder(BotMember member,
        BotSettings settings,
        Func<BotMember, float> getRequiredExperience)
    {
        _member = member;
        _settings = settings;
